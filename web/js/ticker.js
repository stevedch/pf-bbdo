(function($){
    $.fn.tickerme = function(options) {
        ...
        return this.each(function(){
            ...
            var control_styles = '<style type="text/css">#ticker_container{width:60%; margin: 10px auto;}#newscontent{float:left; width: 100%;}#news{display:none}#controls{float: right;height: 16px;position: absolute;right: 22px;bottom: 14px;}.icon{display:inline-block;width:16px;height:16px;fill:'+opts.control_colour+'}.icon:hover{fill:'+opts.control_rollover+'}</style>';
